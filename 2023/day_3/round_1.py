...
def next_numbers_all(line: str, startIndex: int=0) -> list[Tuple[int, int, int]]:
  nums=[]
...
if __name__=='__main__':
  #lines = read_input()
  res = gear_ratios(input.splitlines())
  print(f"Sum is : {res}") 
  # 539127 (input file) 
  # 538046 (input as variable) ==> correct answer
  # why there is different result, i don't know